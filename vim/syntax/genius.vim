...
syntax region geniusInfo start=/^-\{81}$/ end=/^-\{81}$/
...
syntax region WebSearch start="<web_search>" end="</web_search>" contains=@Spell
highlight default link thinking Comment
highlight default link WebSearch Comment
